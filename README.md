...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-21 09:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e370b6a2-e34e-4e2b-a16d-29ed9f1205eb.git
$ cd e370b6a2-e34e-4e2b-a16d-29ed9f1205eb
```
